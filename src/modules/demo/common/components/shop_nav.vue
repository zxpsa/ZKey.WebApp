<style lang="css">
	...
	._vuec .arrow-right> i {
		background-image: url(../../common/img/icon/left_arrow.png);
	...
	._vuec .arrow-right:active,
	._vuec .back-btn:active,
	._vuec .right-btn:active,
	._vuec .other-btn:active {
...
<template lang="html">
	<div class="_vuec">
		...
		<div class="title-text" v-html="title"></div>
